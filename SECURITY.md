...
- State must remain on a local filesystem. Network shares and mapped network drives are unsupported because their exclusive-create and file-identity semantics may not match a local filesystem; an unavailable lock identity fails closed.
